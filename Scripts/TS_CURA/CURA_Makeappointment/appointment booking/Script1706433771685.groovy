...
WebUI.callTestCase(findTestCase('TS_CURA/CURA_Login/Login'), [('link') : 'https://katalon-demo-cura.herokuapp.com/', ('Name') : findTestData(
...
WebUI.setText(findTestObject('cura_healthcare_obj/Cura_booking_appointment/Booking appointment/textarea_Comment_comment'), Comment)
